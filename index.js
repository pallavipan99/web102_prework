...
const displayStr = `
  A total of $${total_Raised.toLocaleString("en-US")} has been raised for 
  ${fundedGames.length} games. Currently, 
  ${unfundedGames.length} ${unfundedGames.length === 1 ? "game remains" : "games remain"} unfunded.
